...
import { Plus, GripVertical, MoreVertical, User, Clock, AlertTriangle } from "lucide-react";
            ...
            return (
              ...
              >
                ...
                <div className="p-3 flex-1 space-y-2.5 min-h-[200px]">
                  ...
                  {/* Add button */}
                  <button className="w-full border-2 border-dashed border-slate-200 hover:border-violet-300 text-slate-400 hover:text-violet-500 rounded-xl py-3 text-xs font-medium flex items-center justify-center gap-1.5 transition-all">
